...
const REQUIRED = {
  NSCameraUsageDescription:
    "책의 문장을 촬영해 빠르게 기록하기 위해 사용합니다. / Used to photograph book text for quick capture.",
  NSPhotoLibraryUsageDescription:
    "저장된 책 사진에서 문장을 인식하기 위해 사용합니다. / Used to recognize text from saved book photos.",
  NSPhotoLibraryAddUsageDescription:
    "기록한 사진을 사진첩에 저장할 수 있도록 사용합니다. / Used to save captured images to your photo library.",
};
...
// Export compliance — HTTPS/TLS only (standard exemption).
